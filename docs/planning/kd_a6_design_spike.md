...
| 触发 | `_archive/pre_r2_kickoff_checklist.md (2026-05-12 归档)` §2.5 KD rehearsal 表 A6 行 |
...
3. `_archive/pre_r2_kickoff_checklist.md (2026-05-12 归档)` §2.5 A6 spike 行状态：`gated on A6 投影层设计` → `complete (path=γ)`
...
- `_archive/pre_r2_kickoff_checklist.md (2026-05-12 归档)` §2.5 A6 行：spike 完成回写
