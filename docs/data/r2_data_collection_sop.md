...
> **状态**：执行 SOP — 相机硬件 2026-05-12 锁定（与 `planning/additional_components_plan.md` §八 同步）；LiDAR 型号待定 → 首日采集复盘后冻结 V1。
> **日期**：2026-04-28
...
*本 SOP 相机硬件 2026-05-12 锁定；LiDAR 锁定 + 首日采集复盘后冻结 V1；后续修订须经数据负责人 + PM 联签。*
