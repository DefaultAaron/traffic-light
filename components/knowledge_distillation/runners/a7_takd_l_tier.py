"""Cell A7 — TAKD via M, ESKD checkpoint, L-tier teacher.
...
Mandatory capacity-gap mitigations (Cho 2019 / Mirzadeh 2020): two of three
must be enabled simultaneously — TAKD intermediate (M assistant), ESKD
early-stopped teacher checkpoint, projection MLP.
